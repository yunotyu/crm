...
<body>
    ...
    <!--表头操作部分-->
    <div id="divListTop">
        <input type="button" onclick=javascript:window.location.href='<%=Url.Action("AddContactRecord",new{id=Model.cust_no}) %>' class="transparent button" value="添加" />
    ...
    <div id="divList">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="tblItem">
                ...
                <td>
                    <a href='<%=Url.Action("UpdateContactRecord") %>/<%=Html.Encode(item.atv_id) %>?no=<%=item.atv_cust_no %>'>
